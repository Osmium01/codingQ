...
import "./signup.css"
import img from '../screen/signup.jpg'
...
const navigate=useNavigate();
    ...
    return (
        ...
        <div id='font'>
        <h3>Create Your Account</h3><h1 id='k'><b>Buddy</b></h1><h5>on CodingQ</h5></div>
        ...
        <div id='contbig'>
            ...
            <h3 id="t">Signup</h3>
                <form  method='POST' onSubmit={handleSubmit}>
                    ...
                    <Link to="/" className='m-3 btn btn-danger' >Alread a user</Link>
                </form>
